...
class Events extends Component {
  state = {
    activeEventId: '',
    activeEventRegistrationStatus: '',
  }

  onChangeActiveEvent = (id, registrationStatus) =>
    this.setState({
      activeEventId: id,
      activeEventRegistrationStatus: registrationStatus,
    })

  render() {
    const {activeEventId, activeEventRegistrationStatus} = this.state
    return (
      <div className="events-app-container">
        ...
        <ActiveEventRegistrationDetails
          key={activeEventId}
          status={activeEventRegistrationStatus}
        />
      </div>
    )
  }
